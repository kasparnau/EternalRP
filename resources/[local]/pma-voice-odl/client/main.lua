...
RegisterCommand('+cycleproximity', function()
	...
	exports['status']:setVoiceMode(voiceMode)
...
exports['jp-keybinds']:registerKeyMapping("cycleProximity", "Voice", "Cycle Proximity", "+cycleProximity", "-cycleProximity", "F11")    
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if lastRadioStatus ~= radioPressed or lastTalkingStatus ~= (NetworkIsPlayerTalking(PlayerId()) == 1) then
			...
			exports['status']:setVoiceColor(lastTalkingStatus and '#fff67d' or 'white')
		end
		Wait(50)
	end
end)
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	exports['status']:setVoiceColor('#ff0000')
	exports['status']:setVoiceMode(3)
	...
	exports['status']:setVoiceColor('white')
	exports['status']:setVoiceMode(2)
