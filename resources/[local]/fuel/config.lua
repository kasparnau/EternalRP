...
Config.Strings = {
	ExitVehicle = "Tankimiseks väljuge sõidukist",
	EToRefuel = "~g~[E] ~w~alusta sõiduki tankimist",
	JerryCanEmpty = "Jerry can on tühi",
	FullTank = "Sõiduk on juba täis",
	CancelFuelingPump = "~g~[E] ~w~lõpeta tankimine",
	CancelFuelingJerryCan = "~g~[E] ~w~lõpeta tankimine",
	NotEnoughCash = "Sul pole piisavalt sularaha",
	TotalCost = "Hind",
}
