...
function EmotesOnCommand(source, args, raw)
  ...
  EmoteChatMessage(Config.Languages['en']['emotemenucmd'])
end
...
exports("cancel", function()
  if IsInAnimation then
    EmoteCancel()
  elseif exports["jp-flags"]:HasPedFlag(PlayerPedId(), 'isSittingOnChair') then
      TriggerEvent("jp-emotes:sitOnChair")
  end
end)
...
function EmoteCommandStart(source, args, raw)
    ...
    elseif DP.PropEmotes[name] ~= nil then
      ...
      EmoteChatMessage("'"..name.."' "..Config.Languages['en']['notvalidemote'].."")
    end
  end
end
  ...
  if ChosenDict == "MaleScenario" or "Scenario" then 
    ...
    if ChosenDict == "MaleScenario" then if InVehicle then return end
      if PlayerGender == "male" then
        ...
        EmoteChatMessage(Config.Languages['en']['maleonly'])
      end return
