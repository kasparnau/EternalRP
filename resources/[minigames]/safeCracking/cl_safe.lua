...
function HandleSafeDialMovement()
	...
	if IsControlPressed(0,34) and currentTimer - lastMovement > 100 then
		lastMovement = currentTimer
		RotateSafeDial("Anticlockwise")
	elseif IsControlPressed(0,35) and currentTimer - lastMovement > 100 then
		lastMovement = currentTimer
